#' Performs DFP for the Horseshoe Prior
#'
...
dfpHorSho <- function(staBat    = 1,
  ...
  return(list(ss = ss, sb = sb, sl = sl, st = st, sv = sv, se = se, XX = XX,
              Xy = Xy, yy = yy, sN = sN, P = P, treshold = treshold))
}
